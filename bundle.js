...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _listQuestion = __webpack_require__(161);

	var _listQuestion2 = _interopRequireDefault(_listQuestion);

	var _deleteQuestion = __webpack_require__(162);

	var _deleteQuestion2 = _interopRequireDefault(_deleteQuestion);

	var _createQuestion = __webpack_require__(163);
	...
	var App = function (_Component) {
	  ...
	  function App(props) {
	    ...
	    if (typeof localStorage.questions != 'undefined') {
	      var stringifiedQuestions = JSON.parse(localStorage.questions);
	      var numberOfQuestions = stringifiedQuestions.length;
	      try {
	        var newQuestions = [];
	    ...
	    // binders
	    _this.handleActiveQuestion = _this.handleActiveQuestion.bind(_this);
	    _this.handleModifyQuestionTitle = _this.handleModifyQuestionTitle.bind(_this);
	    _this.handleModifyOptions = _this.handleModifyOptions.bind(_this);
	    _this.handleAddImage = _this.handleAddImage.bind(_this);
	    _this.addQuestion = _this.addQuestion.bind(_this);
	    _this.handleDeleteSave = _this.handleDeleteSave.bind(_this);
	    _this.handleDeleteMode = _this.handleDeleteMode.bind(_this);
	    _this.releaseQuestionLock = _this.releaseQuestionLock.bind(_this);
	    _this.handleQuestionMode = _this.handleQuestionMode.bind(_this);
	    return _this;
	  }

	  _createClass(App, [{
	    key: 'addQuestion',
	    value: function addQuestion(title, options, img) {
	    ...
	    key: 'handleContitionalSidebar',
	    value: function handleContitionalSidebar(deleteMode) {
	      if (deleteMode) {
	        return _react2.default.createElement(_deleteQuestion2.default, {
	      ...
	      return _react2.default.createElement(_listQuestion2.default, {
	        currentState: this.state,
	        addQuestion: this.addQuestion,
	        handleActiveQuestion: this.handleActiveQuestion,
	        releaseQuestionLock: this.releaseQuestionLock,
	    ...
	    key: 'handleActiveQuestion',
	    value: function handleActiveQuestion(questionID) {
	      this.setState({ activeQuestion: questionID, questionOnMobile: true });
	    }
	  }, {
	    key: 'handleModifyOptions',
	    value: function handleModifyOptions(questionID, optionID, optionText) {
	      var options = this.state.questions[questionID - 1].options;
	      var optionData = ["", "", "", "", "", ""];
	    ...
	    key: 'handleDeleteSave',
	    value: function handleDeleteSave(newQuestions) {
	      localStorage.questions = this.stringifyQuestions(newQuestions);
	    ...
	    key: 'handleDeleteMode',
	    value: function handleDeleteMode(mode) {
	      this.setState({ deleteMode: mode });
	    }
	    // Toggle Question lock to validate question and options as well as prevent blank questions.

	  }, {
	    key: 'releaseQuestionLock',
	    value: function releaseQuestionLock(lock) {
	      this.setState({ questionLock: lock });
	    }
	  }, {
	    key: 'stringifyQuestions',
	    value: function stringifyQuestions(questions) {
	    ...
	    key: 'handleClassLeftOnMobile',
	    value: function handleClassLeftOnMobile() {
	    ...
	    key: 'handleClassRightOnMobile',
	    value: function handleClassRightOnMobile() {
	      if (this.state.questionOnMobile) {
	    ...
	    key: 'handleQuestionMode',
	    value: function handleQuestionMode(mode) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-md-12 app-heading' },
	            _react2.default.createElement(
	              'h3',
	              null,
	              'Quiz Authoring Tool'
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'row quiz-body' },
	          _react2.default.createElement(
	            'div',
	            { className: this.handleClassLeftOnMobile() },
	            this.handleContitionalSidebar(this.state.deleteMode)
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: this.handleClassRightOnMobile() },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ListQuestions = function (_Component) {
	  ...
	  _createClass(ListQuestions, [{
	    ...
	    value: function renderQuestionList() {
	      ...
	      return this.props.currentState.questions.map(function (questions) {
	        var questionIndex = _this2.props.currentState.questions.indexOf(questions) + 1;
	        var colorClass = 'question-item background-blue';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DeleteQuestions = function (_Component) {
	  _inherits(DeleteQuestions, _Component);

	  function DeleteQuestions(props) {
	    _classCallCheck(this, DeleteQuestions);

	    var _this = _possibleConstructorReturn(this, (DeleteQuestions.__proto__ || Object.getPrototypeOf(DeleteQuestions)).call(this, props));

	    _this.state = {
	      questions: _this.props.currentState.questions
	    };
	  ...
	  _createClass(DeleteQuestions, [{
	    ...
	    value: function renderQuestionList() {
	      ...
	      return this.state.questions.map(function (questions) {
	        var questionIndex = _this2.state.questions.indexOf(questions) + 1;
	        var colorClass = 'delete-question question-item background-blue';
	        if (questionIndex % 2 === 0) {
	...
	exports.default = DeleteQuestions;
	...
	var CreateQuestion = function (_Component) {
	  ...
	  _createClass(CreateQuestion, [{
	    ...
	    value: function handleQuestionChange(e) {
	      var response = this.validateText(e.target.value);
	      if (response.error) {
	    ...
	    key: 'validateText',
	    value: function validateText(questionText) {
	      var error = false;
	      var message = questionText + "";
	      if (message.trim() == '') {
	    ...
	    value: function uploadImage(e) {
	      ...
	      var cloudName = _config.cloudinaryKeys.cloudName;
	      var unsignedUploadPreset = _config.cloudinaryKeys.uploadPreset;
	    ...
	    value: function renderImage() {
	      ...
	      if (image === null || typeof image === 'undefined') {
	        ...
	        return _react2.default.createElement('img', { src: imageData.url, height: '50', style: imageStyle });
	      }
	    }
	  }, {
	    key: 'renderOptions',
	    value: function renderOptions() {
	      ...
	      var options = this.props.currentState.questions[this.props.activeQuestion - 1].options;
	      var optionData = ["", "", "", "", "", ""];
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col' },
	            _react2.default.createElement('input', { type: 'text', placeholder: 'Option 1 (required)', className: 'form-control',
	              value: optionData[0],
	              onChange: function onChange(e) {
	                return _this2.props.handleModifyOptions(_this2.props.activeQuestion, 1, e.target.value);
	              }
	            })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col' },
	            _react2.default.createElement('input', { type: 'text', placeholder: 'Option 2(required)', className: 'form-control',
	              value: optionData[1],
	              onChange: function onChange(e) {
	                return _this2.props.handleModifyOptions(_this2.props.activeQuestion, 2, e.target.value);
	              }
	            })
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col' },
	            _react2.default.createElement('input', { type: 'text', placeholder: 'Option 3', className: 'form-control',
	              value: optionData[2],
	              onChange: function onChange(e) {
	                return _this2.props.handleModifyOptions(_this2.props.activeQuestion, 3, e.target.value);
	              }
	            })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col' },
	            _react2.default.createElement('input', { type: 'text', placeholder: 'Option 4', className: 'form-control',
	              value: optionData[3],
	              onChange: function onChange(e) {
	                return _this2.props.handleModifyOptions(_this2.props.activeQuestion, 4, e.target.value);
	              }
	            })
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col' },
	            _react2.default.createElement('input', { type: 'text', placeholder: 'Option 5', className: 'form-control',
	              value: optionData[4],
	              onChange: function onChange(e) {
	                return _this2.props.handleModifyOptions(_this2.props.activeQuestion, 5, e.target.value);
	              }
	            })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col' },
	            _react2.default.createElement('input', { type: 'text', placeholder: 'Option 6', className: 'form-control',
	              value: optionData[5],
	              onChange: function onChange(e) {
	                return _this2.props.handleModifyOptions(_this2.props.activeQuestion, 6, e.target.value);
	              }
	            })
	          )
	        )
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'row onlyonmobile back-to-questions-button', onClick: function onClick() {
	              return _this3.props.handleQuestionMode(false);
	            } },
	          _react2.default.createElement(
	            'span',
	            null,
	            '\uD83D\uDD19 \xA0 Back to Questions'
	          )
	        ),
	        _react2.default.createElement(
	          'h3',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'questionInput', 'aria-describedby': 'questionHelp', placeholder: '',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { type: 'file', id: 'imageUpload', accept: 'image/*',
